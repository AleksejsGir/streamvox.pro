...
export function SmartOverlayDemo({ standalone = true }: SmartOverlayDemoProps) {
        ...
        return (
            <div className="w-full max-w-7xl mx-auto px-4">
                <div className="grid lg:grid-cols-12 gap-8 items-center">
                    <div className="order-2 lg:col-span-4 space-y-5">
                        ...
                        <div className="bg-white/5 p-4 rounded-xl border border-white/10 backdrop-blur-sm">
                            <div className="flex justify-between mb-3">
                                ...
                                <span className="text-primary font-mono text-sm">{opacity}%</span>
                            </div>
                            <input
                                type="range"
                                min="10"
                                ...
                                value={opacity}
                                onChange={(e) => setOpacity(Number(e.target.value))}
                                className="w-full h-1.5 bg-white/10 rounded-lg appearance-none cursor-pointer accent-primary hover:accent-secondary transition-colors"
                                aria-label={t("opacityLabel")}
                            />
                    ...
                    <div className="order-1 lg:col-span-8 relative group">
                        <div className="absolute -inset-1 bg-gradient-to-r from-primary to-secondary rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-1000"></div>
                        <div className="relative rounded-2xl overflow-hidden aspect-video bg-[#0f0f11] border border-white/10 shadow-2xl">
                            <LazyVideo
                                src="/assets/video/StreamVox_movie.mp4"
                            ...
                            />
                            <div
                                className="absolute bottom-6 left-1/2 -translate-x-1/2 w-3/4 p-4 rounded-xl border border-white/10 transition-all duration-100 ease-linear shadow-lg"
                                style={{
                                    backgroundColor: `rgba(0, 0, 0, ${opacity / 100})`,
                                    backdropFilter: "blur(4px)"
                                }}
